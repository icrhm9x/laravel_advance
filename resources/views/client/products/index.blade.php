@extends('client.layouts.app', ['title' => 'Sản phẩm - '])
@section('content')
                ...
                <div class="row row-pb-lg">
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            <div class="product-img"
                                ...
                                <div class="cart">
                                    <p>
                                        ...
                                        <span><a href="/product/id/id"><i class="icon-eye"></i></a></span>
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Quần kaki đỏ man</a></h3>
                    ...
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Quần kaki Nâu </a></h3>
                    ...
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Quần kaki xám</a></h3>
                                <p class="price"><span>3.000.000 đ</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Quần kaki xanh đen</a></h3>
                                <p class="price"><span>3.000.000 đ</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Áo sơ mi ca rô xám xanh</a></h3>
                                <p class="price"><span>3.000.000 đ</span> </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Áo hoạ tiết đen</a></h3>
                                <p class="price"><span>3.000.000 đ</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Áo trắng kẻ vằn</a></h3>
                                <p class="price"><span>3.000.000 đ</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Áo nữ trắng bạch</a></h3>
                                <p class="price"><span>3.000.000 đ</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Áo sơ mi có cổ kẻ ô xám</a></h3>
                                <p class="price"><span>3.000.000 đ</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Váy đầm xoè hoa nổi</a></h3>
                                <p class="price"><span>3.000.000 đ</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Áo nữ chấm bi</a></h3>
                                <p class="price"><span>3.000.000 đ</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            ...
                            <div class="desc">
                                <h3><a href="/product/id/id">Áo nữ nổi viền</a></h3>
                                <p class="price"><span>3.000.000 đ</span></p>
                            </div>
                        </div>
                    </div>
